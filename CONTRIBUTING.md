...
This repository is following the [Contributor Covenant Code of Conduct](https://github.com/OpenEnergyPlatform/oemetadata/blob/main/CODE_OF_CONDUCT.md). <br>
...
If you are a user, please add your name and details in [`📝USERS.cff`](https://github.com/OpenEnergyPlatform/oemetadata/blob/production/USERS.cff).
...
If you wish, add your name and details to [`📝CITATION.cff`](https://github.com/OpenEnergyPlatform/oemetadata/blob/production/CITATION.cff).
...
in the repository. Choose a suitable [Issue Template](https://openenergyplatform.github.io/oemetadata/develop/development/collaboration/git/#issue-templates)
...
- Use the [Pull Request Template](https://github.com/OpenEnergyPlatform/oemetadata/blob/production/.github/pull_request_template.md)
