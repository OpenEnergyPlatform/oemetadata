...
Create the OEMetadata json schema from schemas
    ...
    cd metadata/v2/v21/build_source/scripts/
    python metadata/v2/v21/build_source/scripts/create_schema.py

Create the OEMetadata template and example from json schema

    python metadata/v2/v21/build_source/scripts/create_example_from_schema.py
    python metadata/v2/v21/build_source/scripts/create_template_from_schema.py
