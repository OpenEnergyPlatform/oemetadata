...
| 6                              | version                          | A version string identifying the version of the package.                                                                                                                         | 0.1.0                                                                                                                                                                                 | [dct:hasVersion](http://purl.org/dc/terms/hasVersion)      | Silver                             | [0..1]                             |
| 6                              | image                            | An image to use for this data package. For example, when showing the package in a listing.                                                                                       | https://avatars.githubusercontent.com/u/37101913?s=96&v=4                                                                                                                             | [schema.org:image](https://schema.org/image)               | Gold                               | [0..1]                             |
...
| <div style="width:1em">#</div> | <div style="width:6em">Key</div> | <div style="width:20em">Description</div>             | <div style="width:20em">Example</div> | <div style="width:20em">Ontology Class</div>                                          | <div style="width:4em">Badge</div> | <div style="width:3em">Card.</div> |
|--------------------------------|----------------------------------|-------------------------------------------------------|---------------------------------------|---------------------------------------------------------------------------------------|------------------------------------|------------------------------------|
| 1                              | **modules**                      | An objects with domain specific metadata WIP |                                       |                         |                                    | [0..1]                             |
