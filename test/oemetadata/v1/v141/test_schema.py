...
def test_jsonschema_should_validate_oemetadata_schema():
    ...
    from oemetadata.v1.v141.schema import OEMETADATA_V141_SCHEMA
...
def test_oemetadata_schema_should_have_correct_path():
    ...
    assert get_string(OEMETADATA_V141_SCHEMA["$id"]) == get_string(
        "https://raw.githubusercontent.com/OpenEnergyPlatform/oemetadata/production/oemetadata/v1/v141/schema.json"
